...
Module Module1
    ...
    Dim astring As New String(Chr(61), 81)      'een string met karakter '='
    ...
    'S:\26_824W\MACHINES\BOORMACH\Zayer\
    'S:\26_824W\MACHINES\BOORMACH\Unisign\
    'S:\26_824W\MACHINES\BOORMACH\Sacem\

    'Dim sPath1 As String() = {"S:\26_824W\MACHINES\BOORMACH\Zayer\",
    '                             "S:\26_824W\MACHINES\BOORMACH\Unisign\",
    '                             "S:\26_824W\MACHINES\BOORMACH\Sacem\"}

    Dim sPath1 As String = "I:\26_26\Boorprogrammas\"               'pad waar de boorprogramma's worden weggeschreven

    Dim apparaatName As String() = {"ZAYER", "UNISIGN", "SACEM"}

    Const sPath2 As String = "I:\26_26\Boorprogrammas\"                     'het path waar de invoerfile export.asc staat

#If DEBUG Then
    Const sPath3 As String = "D:\Eigen\Test\"

#End If

    Const sCyclus As String = "BCYCLUS.TXT"                                 ' staat in sPath1 
    ...
    Dim cyclus As New ArrayList             'de lijst met beschikbare cyclussen uit BCYCLUS.TXT

    'array bCyclus bevat dezelfde info als bcyclus.txt
    Dim bCyclus As String() = {"CENTEREN",
                               "VOORBOREN",
                               "BOREN-1",
                               "BOREN-2",
                               "BOREN-3",
    ...
    Sub Main()
        ...
        Console.WriteLine("| Programma : {0,45}                     | ", My.Application.Info.AssemblyName)
        Console.WriteLine("| versie    : {0,45}                     | ", My.Application.Info.Version.ToString)
        ...
        Console.WriteLine("| Company   : {0,45}                     | ", My.Application.Info.CompanyName)
        Console.WriteLine("|             {0,45}                     | ", Space(20))
        Console.WriteLine(astring)
        Console.WriteLine()
        ...
        Console.WriteLine("|             {0,30}                     | ", sPath1)
        Console.WriteLine()

        'lees beschikbare cycli voor machine uit BCYCLUS.TXT 
...
#If DEBUG Then
            ...
            Read_cyclus(sPath3, sCyclus)
#Else


            Read_cyclus(sPath2, sCyclus)
#End If
        End If
...
#If DEBUG Then
        Finish_file(sPath3, sFileName)      ' voor debuggen

#Else
         Finish_file(sPath1, sFileName)
...
#End If
    ...
    'als de file niet bestaat; dan de arraylist gebruiken
    Sub Read_cyclus(ByVal sPath As String, ByVal sName As String)
        ...
        If Not File.Exists(sPath & sName) Then
            ...
            Console.Write("Read_cyclus : {0} does not exist.", sName)
            Console.WriteLine("  Using default cyclus " & vbCrLf)

            'MessageBox.Show("File does not exist  ")

            'bestand niet gevonden, neem dan de cyclussen uit de string array over
            For Each obj As String In bCyclus
                cyclus.Add(obj)
            Next
